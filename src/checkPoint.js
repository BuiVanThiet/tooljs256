      ...
      if (round > MAX_ROUND) {
        ...
        for (let i = 0; i < 3; i++) {
          try {
            ...
            await page.goto("https://seller-us.tiktok.com/health-center", {
        ...
        const point = await getElement(
          page,
          ' [class="relative text-black text-base font-medium "]'
        );
        const pointText = await getText(point);
        resolve(pointText);
